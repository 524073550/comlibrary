...
/**
 * Created by dkyear on 2016/3/4.
 * DES 加密、解密 ISO ANDRIOD 通用
 */
public class DesUtils {
    private final static String DES = "DES";
    //加密键byte数组
    private final static String key = "XGF@171225%API";
    ...
    public static String decrypt(String data) throws DecryptExcption {
        try {
            if (data == null)
                return null;
            byte[] bt = decrypt(Base64.decode(data, Base64.DEFAULT), key.getBytes());
